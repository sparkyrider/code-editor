    ...
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-[var(--bg)]">
      ...
      <div className="flex items-center gap-3 border-b border-[var(--border)] px-5 py-4 shrink-0">
        <button
          type="button"
          onClick={onBack}
          className="flex h-7 w-7 items-center justify-center rounded-lg text-[var(--text-secondary)] transition hover:bg-[var(--bg-subtle)] hover:text-[var(--text-primary)]"
        >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 space-y-5">
        ...
        {/* Connect — Gateway + Mobile + Sessions */}
        <section className="rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] p-4">
          <div className="mb-4 flex items-center gap-2">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--bg-subtle)] text-[var(--brand)]">
            ...
            <div>
              ...
              <p className="text-[11px] text-[var(--text-secondary)]">
                Gateway, mobile access, and active sessions.
              </p>
            </div>
          </div>
